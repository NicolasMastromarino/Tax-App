...
// The monthly/annual toggle + price card shared by the Tax Planner/
// Contractors paywall (UpgradeGate) and the Billing card's unsubscribed
// state, so both look like the marketing pricing section instead of two
// plain price buttons.
export function SubscribeCard({ businessId, email }: { businessId: string; email: string }) {
